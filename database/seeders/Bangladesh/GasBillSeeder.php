...
class GasBillSeeder extends Seeder
{
    /**
    ...
    private function serviceTypes(): array
    {
        ...
        return [
            ['service_type_parent_id' => business()->serviceType()->findWhere(['service_type_slug' => 'gas'])->id, 'service_type_name' => 'Jalalabad Gas', 'service_type_slug' => 'jalalabad_gas', 'logo_svg' => 'data:image/svg+xml;base64,'.base64_encode(file_get_contents($image_svg.'jalalabad_gas.svg')), 'logo_png' => 'data:image/png;base64,'.base64_encode(file_get_contents($image_png.'jalalabad_gas.png')), 'service_type_is_parent' => 'no', 'service_type_is_description' => 'no', 'service_type_step' => '3', 'enabled' => true],
            ['service_type_parent_id' => business()->serviceType()->findWhere(['service_type_slug' => 'gas'])->id, 'service_type_name' => 'Titas Gas', 'service_type_slug' => 'titas_gas', 'logo_svg' => 'data:image/svg+xml;base64,'.base64_encode(file_get_contents($image_svg.'titas_gas.svg')), 'logo_png' => 'data:image/png;base64,'.base64_encode(file_get_contents($image_png.'titas_gas.png')), 'service_type_is_parent' => 'no', 'service_type_is_description' => 'no', 'service_type_step' => '3', 'enabled' => true],
            ['service_type_parent_id' => business()->serviceType()->findWhere(['service_type_slug' => 'gas'])->id, 'service_type_name' => 'Titas Gas Metered', 'service_type_slug' => 'titas_gas_metered', 'logo_svg' => 'data:image/svg+xml;base64,'.base64_encode(file_get_contents($image_svg.'titas_gas.svg')), 'logo_png' => 'data:image/png;base64,'.base64_encode(file_get_contents($image_png.'titas_gas.png')), 'service_type_is_parent' => 'no', 'service_type_is_description' => 'no', 'service_type_step' => '3', 'enabled' => true],
            ['service_type_parent_id' => business()->serviceType()->findWhere(['service_type_slug' => 'gas'])->id, 'service_type_name' => 'Bakhrabad Gas', 'service_type_slug' => 'bakhrabad_gas', 'logo_svg' => 'data:image/svg+xml;base64,'.base64_encode(file_get_contents($image_svg.'bakhrabad_gas.svg')), 'logo_png' => 'data:image/png;base64,'.base64_encode(file_get_contents($image_png.'bakhrabad_gas.png')), 'service_type_is_parent' => 'no', 'service_type_is_description' => 'no', 'service_type_step' => '3', 'enabled' => true],
            ['service_type_parent_id' => business()->serviceType()->findWhere(['service_type_slug' => 'gas'])->id, 'service_type_name' => 'Paschimanchal Gas', 'service_type_slug' => 'paschimanchal_gas', 'logo_svg' => 'data:image/svg+xml;base64,'.base64_encode(file_get_contents($image_svg.'paschimanchal_gas.svg')), 'logo_png' => 'data:image/png;base64,'.base64_encode(file_get_contents($image_png.'paschimanchal_gas.png')), 'service_type_is_parent' => 'no', 'service_type_is_description' => 'no', 'service_type_step' => '3', 'enabled' => true],
            ['service_type_parent_id' => business()->serviceType()->findWhere(['service_type_slug' => 'gas'])->id, 'service_type_name' => 'Karnaphuli Gas Metered', 'service_type_slug' => 'karnaphuli_gas_metered', 'logo_svg' => 'data:image/svg+xml;base64,'.base64_encode(file_get_contents($image_svg.'karnaphuli_gas.svg')), 'logo_png' => 'data:image/png;base64,'.base64_encode(file_get_contents($image_png.'karnaphuli_gas.png')), 'service_type_is_parent' => 'no', 'service_type_is_description' => 'no', 'service_type_step' => '3', 'enabled' => true],
            ['service_type_parent_id' => business()->serviceType()->findWhere(['service_type_slug' => 'gas'])->id, 'service_type_name' => 'Karnaphuli Gas Non-Metered', 'service_type_slug' => 'karnaphuli_gas_non_metered', 'logo_svg' => 'data:image/svg+xml;base64,'.base64_encode(file_get_contents($image_svg.'karnaphuli_gas.svg')), 'logo_png' => 'data:image/png;base64,'.base64_encode(file_get_contents($image_png.'karnaphuli_gas.png')), 'service_type_is_parent' => 'no', 'service_type_is_description' => 'no', 'service_type_step' => '3', 'enabled' => true],
        ];
    }
