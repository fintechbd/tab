...
class PayBillSeeder extends Seeder
{
    ...
    private function serviceTypes(): array
    {
        ...
        return [
            ...
            ['service_type_parent_id' => Business::serviceType()->list(['service_type_slug' => 'electricity'])->first()->id, 'service_type_name' => 'BREB Prepaid', 'service_type_slug' => 'breb_prepaid', 'logo_svg' => 'data:image/svg+xml;base64,'.base64_encode(file_get_contents($image_svg.'breb.svg')), 'logo_png' => 'data:image/png;base64,'.base64_encode(file_get_contents($image_png.'breb.png')), 'service_type_is_parent' => 'no', 'service_type_is_description' => 'no', 'service_type_step' => '3', 'enabled' => true],
