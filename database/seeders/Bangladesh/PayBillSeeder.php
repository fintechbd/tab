...
class PayBillSeeder extends Seeder
{
    ...
    private function serviceTypes(): array
    {
        ...
        return [
            ...
            ['service_type_parent_id' => Business::serviceType()->list(['service_type_slug' => 'gas'])->first()->id, 'service_type_name' => 'Karnaphuli Gas Metered', 'service_type_slug' => 'karnaphuli_gas_metered', 'logo_svg' => 'data:image/svg+xml;base64,' . base64_encode(file_get_contents($image_svg . 'karnaphuli_gas.svg')), 'logo_png' => 'data:image/png;base64,' . base64_encode(file_get_contents($image_png . 'karnaphuli_gas.png')), 'service_type_is_parent' => 'no', 'service_type_is_description' => 'no', 'service_type_step' => '3', 'enabled' => true],
            ['service_type_parent_id' => Business::serviceType()->list(['service_type_slug' => 'gas'])->first()->id, 'service_type_name' => 'Karnaphuli Gas Non-Metered', 'service_type_slug' => 'karnaphuli_gas_non_metered', 'logo_svg' => 'data:image/svg+xml;base64,' . base64_encode(file_get_contents($image_svg . 'karnaphuli_gas.svg')), 'logo_png' => 'data:image/png;base64,' . base64_encode(file_get_contents($image_png . 'karnaphuli_gas.png')), 'service_type_is_parent' => 'no', 'service_type_is_description' => 'no', 'service_type_step' => '3', 'enabled' => true],
        ];
    }
